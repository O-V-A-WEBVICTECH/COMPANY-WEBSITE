  ...
  website: {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Meta tags, sitemaps, structured data, and performance tuning.",
        min: 30000,
        max: 80000,
      },
      {
      ...
      },
      {
        ...
        description:
          "Real-time chat or support integration (e.g. Intercom, Crisp).",
        min: 20000,
        max: 50000,
      },
      {
    ...
    features: [
      {
        ...
        description:
          "JWT/OAuth2, role-based access control, session management.",
        min: 70000,
        max: 140000,
      },
      {
      ...
      },
      {
        ...
        description:
          "Transactional emails, SMS alerts, and push notifications.",
        min: 25000,
        max: 60000,
      },
      {
      ...
      },
      {
        ...
        description:
          "Redis, in-memory caching, rate limiting, and query optimisation.",
        min: 40000,
        max: 100000,
      },
      {
        ...
        description:
          "Swagger / OpenAPI auto-generated docs and developer guides.",
        min: 30000,
        max: 80000,
      },
    ],
