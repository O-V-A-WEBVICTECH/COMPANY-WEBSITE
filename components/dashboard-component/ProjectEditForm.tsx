...
export default function ProjectEditForm({
  ...
  async function updateProject(event: FormEvent<HTMLFormElement>) {
    ...
    setLoading(true);
    try {
      let imageUrl: string | undefined = removedImage
        ? undefined
          ...
          <div className="relative rounded-xl overflow-hidden border-2 border-slate-200 group">
            ...
            {!selectedFile &&
              ...
              imagePreview === project.image && (
                <div className="absolute top-3 left-3 text-[11px] font-semibold bg-slate-800/70 text-white px-2 py-0.5 rounded-full">
                  Current
                </div>
              )}
            {selectedFile && (
              <div className="absolute top-3 left-3 text-[11px] font-semibold bg-blue-600/90 text-white px-2 py-0.5 rounded-full">
