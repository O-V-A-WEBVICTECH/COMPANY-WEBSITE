      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-9 h-10 border-slate-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
          />
        </div>
        <div className="relative">
      ...
      >
        {loading ? (
          <>
            ...
            {selectedFile ? "Uploading & saving…" : "Adding member…"}
          </>
        ) : (
          "Add Team Member"
        )}
